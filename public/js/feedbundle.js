...
var FeedPost = React.createClass({
    displayName: 'FeedPost',

    componentWillMount: function componentWillMount() {
        this.loadDataFromRedis();
        setInterval(this.loadDataFromRedis, 1000);
    },
    loadDataFromRedis: function loadDataFromRedis(dataGet) {
    ...
    render: function render() {
        var createFeed = function createFeed(dataGet) {
...
var FeedInput = React.createClass({
    ...
    saveDataToRedis: function saveDataToRedis() {
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement('textarea', { onChange: this.onChange, value: this.state.text, className: 'form-control update-form', placeholder: 'Tell us what you been up to...', name: 'update', cols: '50', row: '10' }),
                        React.createElement(
                            'button',
            ...
            React.createElement(FeedPost, { feed: this.state.feed })
        );
    }
